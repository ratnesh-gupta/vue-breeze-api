        ...
        <div class="w-full px-4">
          <div
            ...
            <form @submit.prevent="authStore.handleRegister(form)">
              ...
              <div class="mb-6">
                <input
                    type="password" placeholder="Password Confirmation" v-model="form.password_confirmation"
                    class="border-[#E9EDF4]  w-full rounded-md border bg-[#FCFDFE] py-3 px-5 text-base text-body-color placeholder-[#ACB6BE] outline-none focus:border-primary focus-visible:shadow-none"/>
              </div>
              <div class="mb-10">
            ...
            <p class="text-base text-[#adadad]">
              <router-link :to="{ name: 'Login' }" class="text-primary hover:underline">Sign In</router-link>
            </p>
          </div>
        </div>
      </div>
